...
|  ___/| '_ \\ / _ \\| '_ \\ / _ \\  _ < / _ \\ / _ \\| |/ /
| |    | | | | (_) | | | |  __/ |_) | (_) | (_) |   < 
|_|    |_| |_|\\___/|_| |_|\\___|____/ \\___/ \\___/|_|\\_\\   by Artem Danyaev
...
(3) Home''')
            ...
            print("New contact created. Press enter to continue")
            input()
            continue
            ...
            while True:
                print(
                    "Enter name and surname of the contact in this format 'Name;Surname', print \"all\" to see all contacts or \"back\" to go back to menu")
                s = input()
                if s == "all":
                    os.system('cls' if os.name == 'nt' else 'clear')
                    print(book)
...
(8) back to menu''')
                    ...
                    if com == '2':
                        ...
                        surname = newsurname
                        print("Contact successfully edited. Press enter to continue")
                        input()
                        os.system('cls' if os.name == 'nt' else 'clear')
                        continue
                        ...
                        if opt == len(nums):
                            ...
                            if number[0] == '+':
                                number = '8' + number[2:]
                            book.add_number(name, surname, cats[cat], number)
                            print("New number successfully added. Press enter to continue")
                            input()
                            os.system('cls' if os.name == 'nt' else 'clear')
                            continue
                        ...
                        print("Date successfully edited. Press enter to continue")
                        input()
                        os.system('cls' if os.name == 'nt' else 'clear')
                        continue
                    elif com == '7':
            ...
            while True:
                print(
                    "Enter name and surname of the contact that you want to delete in this format 'Name;Surname', type \"all\" so see all contacts or \"back\" to go back to menu: ")
                com = input()
                if com == "all":
                    os.system('cls' if os.name == 'nt' else 'clear')
                    print(book)
            ...
            while True:
                print(
                    "Enter name and surname of the contact in this format 'Name;Surname', type \"all\" so see all contacts or \"back\" to go back to menu: ")
                com = input()
                if com == "all":
                    os.system('cls' if os.name == 'nt' else 'clear')
                    print(book)
        ...
        os.system('cls' if os.name == 'nt' else 'clear')
        print('Unknown error. Press enter to continue')
        skip = False
        skip_input = False
        input()
        continue
